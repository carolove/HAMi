...
helm template hami-scheduler  charts/hami \
 ...
 --set scheduler.extender.image=harbor.123.125.194.106.nip.io:10443/matrixdc-system/hami  \
 --set scheduler.enabled=true --set scheduler.kubeScheduler.plugins.enabled=false  \
 --set devicePlugin.enabled=false   --set version=v2.3.12-20241021-77c4d60 \
